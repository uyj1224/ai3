...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    labels[2]:{"texts":["이명박은 제 17대 대통령이다."],
              ...
              "images":["https://i.namu.wiki/i/gFjTwnSEyA84kZkqzFDKcglfXlef7BVm-JLPaMEfxdZSSVUuDbedHxABxuvKStnwwvOXNGtQhaFBT96dFfcBmA.webp"],
              },
    labels[3]:{"texts":["이승만은 제 1~3대 대통령이다."],
              "videos":["https://www.youtube.com/shorts/Phho_HblBN4"],
              "images":["https://contents.kyobobook.co.kr/sih/fit-in/400x0/pdt/9788965239581.jpg"],
              },
}
